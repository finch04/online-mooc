...
public class CourseController {
    ...
    @io.swagger.v3.oas.annotations.Operation(summary = "用户端课程搜索接口")
    @GetMapping("/portal")
    ...
    @io.swagger.v3.oas.annotations.Operation(summary = "处理指定课程上架失败的问题")
    @PostMapping("/up")
    ...
    @io.swagger.v3.oas.annotations.Operation(summary = "处理指定课程下架失败的问题")
    @PostMapping("/down")
